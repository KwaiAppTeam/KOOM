...
import kshark.HprofRecord.HeapDumpRecord.ObjectRecord.ClassSkipContentRecord
import kshark.HprofRecord.HeapDumpRecord.ObjectRecord.InstanceSkipContentRecord
import kshark.HprofRecord.HeapDumpRecord.ObjectRecord.ObjectArraySkipContentRecord
import kshark.HprofRecord.HeapDumpRecord.ObjectRecord.PrimitiveArraySkipContentRecord
...
internal class HprofInMemoryIndex private constructor(
    ...
    return objectArrayIndex.entrySequence()
        .map {
          ...
          val objectArray = IndexedObjectArray(
              ...
              size = array.readInt()//object array index增加size
          )
          id to objectArray
        }
  }
    ...
    return primitiveArrayIndex.entrySequence()
        .map {
          ...
          val primitiveArray = IndexedPrimitiveArray(
              ...
              size = array.readInt()//primitive array index增加size
          )
  ...
  private class Builder(
    ...
    private val classIndex = UnsortedByteEntries(
        bytesPerValue = positionSize + identifierSize + 4/*instance size*/,
    ...
    private val objectArrayIndex = UnsortedByteEntries(
        bytesPerValue = positionSize + identifierSize + 4/*array length*/,
        longIdentifiers = longIdentifiers,
        initialCapacity = objectArrayCount
    )
    private val primitiveArrayIndex = UnsortedByteEntries(
        bytesPerValue = positionSize + 1 + 4/*array length*/,
        longIdentifiers = longIdentifiers,
  ...
  companion object {
    ...
    fun createReadingHprof(
      ...
      SharkLog.d { "classCount:${classCount} instanceCount:${instanceCount} objectArrayCount:${objectArrayCount} primitiveArrayCount:${primitiveArrayCount}" }
